...
# https://github.com/houdini91/uefi-supply-chain/blob/main/docs/normalized-module-hash-profile.md
#
...
def normalized_sha256(section_type: int, payload: bytes) -> Optional[str]:
    ...
    the same module never match, and neither matches a plain SHA-256 of the bytes.
    """
